...
@Service
public class LoginServiceImpl implements LoginService<String> {
    ...
    public ResponseEntity<String> login(User user) {
        ...
        MultiValueMap<String, String> map = HttpParamsMapBuilder
                .builder()
                .withClient(clientId)
                .withClientSecret(clientSecret)
                .withGrantTyoe(grantType)
        ...
        try {
            ResponseEntity<String> response = httpComponent
                    .restTemplate()
                    .postForEntity(
